...
public class CalculadoraRestController {
    ...
    public RedirectView somarQuery(@RequestParam(value = "n1", defaultValue = "0") String n1,
    ...
    public Double somarPath(@PathVariable String numero1, 
    ...
    public ModelAndView calcularPotenciaQuery(@RequestParam(value = "base", defaultValue = "0") String base,
    						 	       ...
    						 	       ModelMap modeloMap) {	
    	modeloMap.addAttribute("valor", base);
    	modeloMap.addAttribute("expoente", expoente);
    	return new ModelAndView("forward:/calcular-potencia-path/" + base + "/" + expoente, modeloMap);
    }
    ...
    public Double calcularPotenciaPath(@PathVariable String base,
    					    		   ...
    					    		   @ModelAttribute("base") String baseModel,
    					    		   @ModelAttribute("expoente") String expoenteModel,
    		    					   Model modelo) {
    	System.out.println(modelo.getAttribute("base"));
    	System.out.println(modelo.getAttribute("expoente"));
